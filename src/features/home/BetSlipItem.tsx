  ...
  return (
    <div className="flex items-center shadow-sm bg-gray-500 rounded-sm py-1 px-1 my-1">
      ...
      <div className="flex justify-between w-[calc(100%-2rem)] ">
        <div>
          <h1 className="text-xs text-gray-100">Today</h1>
          <p className="text-xs text-gray-200">English Premier League</p>
          <p className="text-xs font-medium">Tottenham Hotspur- Brentford</p>
        </div>
        <div className="">
        <h1 className="text-xs text-gray-100 text-end">22:00</h1>
          <p className="text-xs text-gray-200">Doubl Chance 12</p>
          <div className="rounded-full w-6 h-6 flex justify-center items-center bg-red-700 text-white text-xs right-0">
          <p className="text-xs text-end">5.3</p>
          </div>
