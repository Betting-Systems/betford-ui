...
export default function HomeLayout() {
  ...
  return (
    <div className="block md:flex md:items-start">
      <div className=" w-full block md:flex md:w-2/3 bg-gray-800 md:items-start">
        ...
        <div className="w-72 px-2 h-36 overflow-y-auto">
         <h1 className="px-2 text-lg">Today's Winners</h1>
         <ul>
         {
          congrats.map((congrat, index) => (
            <li key={index} className="flex">
            <p className="text-xs">Congradulations Today2:51 <span>Win 21000</span></p>
